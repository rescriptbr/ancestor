...
function Make(Maker) {
  ...
  var createStack = function createStack(direction) {
  ...
  var Ancestor_Stack$Make = function Ancestor_Stack$Make(Props) {
    ...
    var tmp = {
      tag: tag,
      className: createStack(direction) + " " + className
    };
...
function Make(StylesMaker) {
  ...
  var Stack = Ancestor_Stack.Make(StylesMaker);
...
//# sourceMappingURL=main.787b39d3853d91e5bdcf.hot-update.js.map