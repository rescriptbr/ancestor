...
function Make(Config) {
  ...
  var toString$24 = function toString$24(gap) {
    ...
    if (len !== 1) {
      if (len !== 0) {
        var value = Belt_Option.mapWithDefault(Belt_Array.get(values, 0), "0", spacingToString);
        var value2 = Belt_Option.mapWithDefault(Belt_Array.get(values, 1), "0", spacingToString);
        return value + " " + value2;
      } else {
        return "0 0";
      }
...
//# sourceMappingURL=main.8589b98f7c840606bd98.hot-update.js.map