...
function Make(Config) {
  ...
  var getBreakpointValue = function getBreakpointValue(innerWidth, values) {
    return Curry._1(Config.unboxBreakpointValue, Belt_Option.getExn(Caml_option.undefined_to_opt(values.find(function (value) {
  ...
  var useResponsiveValue = function useResponsiveValue(values) {
    return getBreakpointValue(initialWidth, values);
  };
...
//# sourceMappingURL=main.fdf68e47832818fe0255.hot-update.js.map