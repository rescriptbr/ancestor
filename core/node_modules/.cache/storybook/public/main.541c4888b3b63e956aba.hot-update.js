...
function Make(Maker) {
  ...
  var createStack = function createStack(direction, spacing, param) {
    var spacingStyles = Curry._3(Styles.ResponsiveProps.make, spacing, undefined, function (spacing) {
      return "gap: " + Curry._1(Styles.Spacing.make, spacing) + ";";
    });

    var directionStyles = Curry._3(Styles.ResponsiveProps.make, direction, "flex-direction: row;", function (direction) {
...
//# sourceMappingURL=main.541c4888b3b63e956aba.hot-update.js.map