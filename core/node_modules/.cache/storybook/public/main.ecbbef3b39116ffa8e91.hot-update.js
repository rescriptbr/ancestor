...
function Make(Maker) {
  ...
  var make$2 = function make$2(values) {
    return function (param) {
      return values.reduce(function (styles, param) {
        var transformer = param.transformer;
        var values = param.values;
        var propStyles = values !== undefined ? Belt_Array.reduce(values.sort(sortBySize), "", function (currentStyles, value) {
          var parsed = Curry._1(Maker.unboxBreakpointValue, value);

          return mediaQuery(currentStyles, value, Curry._1(transformer, parsed));
        }) : param.defaultStyles;
        return styles.concat(propStyles);
      }, param);
    };
  };
...
//# sourceMappingURL=main.ecbbef3b39116ffa8e91.hot-update.js.map