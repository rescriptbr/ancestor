...
function Make(Maker) {
  ...
  var createResponsivePropStyles = function createResponsivePropStyles(prop, defaultStyles, mapper) {
    var reducer = function reducer(currentStyles, value) {
      var parsed = Curry._1(Maker.unboxBreakpointValue, value);

      return Curry._3(Styles.mediaQuery, currentStyles, value, Curry._1(mapper, parsed));
    };

    return Belt_Option.getWithDefault(Belt_Option.map(prop, function (values) {
  ...
  var createStack = function createStack(direction, param) {
    var createDirectionStyles = function createDirectionStyles(currentStyles, value) {
      var valueParsed = Curry._1(Maker.unboxBreakpointValue, value);

      return Curry._3(Styles.mediaQuery, currentStyles, value, "\n          flex-direction: " + (valueParsed === "horizontal" ? "column" : "row") + "\n        ");
    };

    var directionStyles = Belt_Option.getWithDefault(Belt_Option.map(direction, function (values) {
      return Belt_Array.reduce(values.sort(function (param, param$1) {
        return Curry._2(Styles.sortBySize, param, param$1);
  ...
  var Ancestor_Stack$Make = function Ancestor_Stack$Make(Props) {
    ...
    var tmp = {
      tag: tag,
      className: createStack(direction, undefined) + " " + className
    };
  ...
  return {
    Styles: Styles,
    Base: Base,
    createResponsivePropStyles: createResponsivePropStyles,
...
//# sourceMappingURL=main.3b9029938f60c2e71272.hot-update.js.map