...
function Make(Maker) {
  ...
  var createStack = function createStack(direction, spacing, param) {
    var directionStyles = Curry._3(Styles.createResponsiveStylesByProp, direction, "flex-direction: row;", function (direction) {
      return "\n          flex-direction: " + (direction === "horizontal" ? "column" : "row") + ";\n      ";
    });

    var spacingStyles = Curry._3(Styles.createResponsiveStylesByProp, spacing, "", function (spacing) {
  ...
  var Ancestor_Stack$Make = function Ancestor_Stack$Make(Props) {
    ...
    var tmp = {
      tag: tag,
      className: createStack(direction, undefined, undefined) + " " + className
    };
...
//# sourceMappingURL=main.3f6ccf55aeadfacad672.hot-update.js.map