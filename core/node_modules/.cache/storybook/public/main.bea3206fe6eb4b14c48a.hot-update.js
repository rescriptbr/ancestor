...
function Make(Maker) {
  ...
  var createResponsiveProp = function createResponsiveProp(value, defaultStylesOpt, transform) {
    var defaultStyles = defaultStylesOpt !== undefined ? defaultStylesOpt : "";

    if (value !== undefined) {
      return value.sort(sortBySize).reduce(function (currentStyles, value) {
...
//# sourceMappingURL=main.bea3206fe6eb4b14c48a.hot-update.js.map